...
<template>
  <component
    ...
    v-bind="attrs"
    :loading="loading"
    class="button font-medium cursor-pointer py-2 px-4 rounded flex items-center justify-center gap-2 disabled:not-[loading=true]:cursor-not-allowed disabled:not-[loading=true]:opacity-50"
    :class="btnClass"
  >
    <Icon
    ...
    <svg
      v-if="loading"
      aria-hidden="true"
      class="inline w-6 h-6 animate-spin fill-primary"
      viewBox="0 0 100 101"
      fill="none"
